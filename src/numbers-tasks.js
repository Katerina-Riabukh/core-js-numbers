 ...
 * // Use Math.acos to calculate the angle in radians
 ...
 *     0     => 0
 *
 *  return Number(value.toString(10).slice(1, -1));
 */
 ...
 *   1  => 1
 *
 * The function directly calculates the sum using the formula
 * 𝑛(𝑛+1)/2.
 * The formula takes n, multiplies it by 𝑛+1, and divides the result by 2.
 */
 ...
 * 15 => 8
 *
 * Start from 1 and increment by 2 (to iterate through odd numbers).
 * Start from -1 and decrement by 2 (to iterate through negative odd numbers).
 */
